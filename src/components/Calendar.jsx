...
export default function Calendar() {
  ...
  function newEventClose(event) {
    ...
    document.getElementById(item + "newEvent").style.animation =
      "slideOutRigh .6s ease-out forwards";
  }

  function setNewEvent(event) {
    let item = event.target.attributes[0].value;
    let selectedTime;
    selectedTime = event.target.attributes[0].value;
    ...
    else item = event.target.parentNode.parentNode.parentNode.childNodes[1].id;
    item = item[0] + item[1];
    console.log(item);
  ...
  function intervalChange(event) {
    const item = Number(event.target.attributes[0].value.split("_")[0]);
    const whichButton = Number(event.target.attributes[0].value.split("_")[2]);
    console.log(`btn ${whichButton}`);
    switch (whichButton) {
      case 5:
        document.getElementById(`${item}_hour_list_5`).style.transform = "translateX(0)";
        document.getElementById(`${item}_hour_list_30`).style.transform = "translateX(0)";
        document.getElementById(`${item}_hour_list_60`).style.transform = "translateX(0)";
        break;
      case 30:
        document.getElementById(`${item}_hour_list_5`).style.transform = "translateX(-27rem)";
        document.getElementById(`${item}_hour_list_30`).style.transform = "translateX(-27rem)";
        document.getElementById(`${item}_hour_list_60`).style.transform = "translateX(-27rem)";
        break;
      case 60:
        document.getElementById(`${item}_hour_list_5`).style.transform = "translateX(-54rem)";
        document.getElementById(`${item}_hour_list_30`).style.transform = "translateX(-54rem)";
        document.getElementById(`${item}_hour_list_60`).style.transform = "translateX(-54rem)";
        break;
  ...
  function setEventHeight() {
    ...
    let event = document.getElementById(`event_23_0`);
    if (event) {
      ...
      <div className="col rightCol">
        <div className="content">
          ...
          <ul id="months" className="months">
            ...
            <ListItem onClick={monthSelected} itemContent="Mar" datavalue="3" />
            <ListItem onClick={monthSelected} itemContent="Apr" datavalue="4" />
            <ListItem onClick={monthSelected} itemContent="May" datavalue="5" />
            <ListItem onClick={monthSelected} itemContent="Jun" datavalue="6" />
            <ListItem onClick={monthSelected} itemContent="Jul" datavalue="7" />
            <ListItem onClick={monthSelected} itemContent="Aug" datavalue="8" />
            <ListItem onClick={monthSelected} itemContent="Sep" datavalue="9" />
            <ListItem onClick={monthSelected} itemContent="Oct" datavalue="10" />
          ...
          <ul className="weekday">
            <ListItem itemContent="Mon" datavalue="1" isWeekDay={true} />
            <ListItem itemContent="Tue" datavalue="2" isWeekDay={true} />
            <ListItem itemContent="Wed" datavalue="3" isWeekDay={true} />
            <ListItem itemContent="Thu" datavalue="4" isWeekDay={true} />
            <ListItem itemContent="Fri" datavalue="5" isWeekDay={true} />
            <ListItem itemContent="Sat" datavalue="6" isWeekDay={true} />
            <ListItem itemContent="Sun" datavalue="7" isWeekDay={true} />
          </ul>
          <div className="clearfix"></div>
                  ...
                  <div className="days-window">
                    <div className="days-window-style days--info">
                      ...
                      <div className="interval-list--wrapper">
                        <IntervalList id={`${item}_hour_list_5`} timeUnits={minutes} item={item} setNewEvent={setNewEvent} />
                        <IntervalList id={`${item}_hour_list_30`} timeUnits={halfHours} item={item} setNewEvent={setNewEvent} />
                        <IntervalList id={`${item}_hour_list_60`} timeUnits={hours} item={item} setNewEvent={setNewEvent} />
                      </div>
                    </div>
